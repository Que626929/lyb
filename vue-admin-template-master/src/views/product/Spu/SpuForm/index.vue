        ...
        <el-form label-width="80px" :model="spu">
            ...
            <el-form-item label="SPU图片">
                <!-- 上传图片：action图片上传的地址
                    ...
                    on-preview：图片预览时会触发
                    on-remove：删除图片时会触发
                    file-list：照片墙需要展示的数据【数组：数据里面的元素务必要有name，url属性】
                 -->
            ...
            <el-form-item label="销售属性">
                ...
                <el-table style="100%" border :data="spu.spuSaleAttrList">
                    <el-table-column label="序号" type="index" width="80px" align="centen"></el-table-column>
...
export default {
    ...
    methods: {
        ...
        handleRemove(file, fileList) {
            ...
            //file参数:代表的是删除的那张图片
            //fileList参数：照片墙删除某一张图片以后，剩余的其他的图片
            //收集照片墙的数据
        ...
        addSaleAttrValue(row) {
            //点击销售属性值当中添加的时候，需要有button变为input，通过当前销售属性的inputVisible控制
        ...
        cancel() {
            ...
            //组件实例this._data，可以操作data当中的相应式数据
    ...
    computed: {
        ...
        unSelectsaleAttr() {
            ...
            //数组过滤的方法，可以从已有的数组当中过滤出用户需要的元素，并且返回一共新的数据
