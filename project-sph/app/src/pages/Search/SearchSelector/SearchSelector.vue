  ...
  <div class="clearfix selector">
    <div class="type-wrap logo">
      ...
      <div class="value logos">
        <ul class="logo-list" v-for="(trademark,index) in trademarkList" :key="trademark.tmId" @click="tradeMatkHandler(trademark)">
  ...
  export default {
    ...
    methods:{
      ...
      tradeMatkHandler(trademark){
        //点击了品牌，还是需要重新整理参数，向服务器发请求获取相应的数据进行展示
        //在父组件发请求，因为父组件中的searchParams参数是带给服务器的参数，子组件把你点击的品牌的信息，需要给父组件传递过去---自定义事件
